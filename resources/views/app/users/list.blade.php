...
<div class="row">
    <div class="col-4">
        <form action="{{ route('search-users') }}" method="get" class="form-search">
                    ...
                    <nav aria-label="Page navigation example">                        
                        <ul class="pagination mb-0">
                            ...
                            <li class="page-item prev">
                                <a class="page-link" href="{{ ($search) ? route('search-users', ['p' => $p - 1 ]).'?text='.$search:route('users', ['p' => $p - 1 ]) }}" aria-label="Anterior">
                            ...
                            @if ($pages > 5)
                            <li class="page-item">
                                <a class="page-link" href="{{ ($search) ? route('search-users', ['p' => 1 ]).'?text='.$search:route('users', ['p' => 1 ]) }}">1</a>
                            </li>
                            <li class="page-item">
                                <span>...</span>
                            </li>
                            ...
                            @if ($n_pages >= 5)
                                @for ($i = $p; $i <= $p + 4; $i++)
                                <li class="page-item {{ ($i == $p) ? 'active':'' }}" {{ ($i == $p) ? 'aria-current="page"':'' }}><a class="page-link" href="{{ ($search) ? route('search-users', ['p' => $i ]).'?text='.$search:route('users', ['p' => $i ]) }}">{{ $i }}</a></li>
                                @endfor                             
                            @else
                                @if ($pages > 5)
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ ($search) ? route('search-users', ['p' => $pages ]).'?text='.$search:route('users', ['p' => $pages ]) }}">{{ $pages }}</a>
                            </li>  
                            @endif
                            
                            <li class="page-item next">
                                <a class="page-link" href="{{ ($search) ? route('search-users', ['p' => $p + 1 ]).'?text='.$search:route('users', ['p' => $p + 1 ]) }}" aria-label="Siguiente">
